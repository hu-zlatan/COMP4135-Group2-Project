...
| M12. Visual asset integration pass | In progress | `coursework/Assets/Resources/UITheme/`, `coursework/Assets/Scripts/UI/UiThemeResources.cs`, `coursework/Assets/Scripts/Presentation/UnitVisualShell.cs`, `doc/src/project-records/testing/post-wr3-visual-smoke-2026-04-24.md`, `doc/src/project-records/testing/post-wr3-ambience-smoke-2026-04-24.md` | The milestone now covers three thin slices: HUD theming, unit and board replacement, and a tabletop ambience pass that decorates both the world layer and the title/result flow without regressing interaction stability |
| M13. HUD feedback completion | Implemented | `coursework/Assets/Scripts/UI/BattleUI.cs`, `coursework/Assets/Scripts/UI/CardButtonView.cs`, `coursework/Assets/Scripts/UI/UnitHealthBarView.cs`, `doc/src/project-records/testing/post-wr3-hud-feedback-smoke-2026-04-24.md`, `doc/src/project-records/process/post-wr3-m12-m13-issue-log-2026-04-24.md` | Title overlay sections are separated, the top-bar prompt stack no longer overlaps, the hand dock no longer obscures lower units at battle start, cards surface explicit disabled reasons, and units expose runtime health bars instead of hiding state in the log |
