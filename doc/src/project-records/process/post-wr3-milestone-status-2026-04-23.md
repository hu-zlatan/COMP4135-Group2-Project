...
| M12. Visual asset integration pass | In progress | `coursework/Assets/Resources/UITheme/`, `coursework/Assets/Scripts/UI/UiThemeResources.cs`, `coursework/Assets/ThirdParty/Kenney/NOTICE.md` | The first integration slice replaces prototype HUD and flow chrome with imported Kenney sprites while leaving character-model replacement for a later pass |
