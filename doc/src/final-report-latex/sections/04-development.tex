...
\caption{High-level runtime architecture for \projectname{}, updated with the refined final-report layout to keep connectors visually separate from the module boxes.}
...
\begin{figure}[H]
\centering
\input{figures/wireframe-layout.tex}
...
The figures above preserve the earlier runtime evidence already referenced by the report. To support a clearer final comparison, the following refreshed captures from the latest build sit alongside the earlier figures rather than silently replacing them.

\begin{figure}[H]
\centering
\includegraphics[width=0.88\textwidth]{title-screen-final.png}
\caption{Updated main-menu screen from the latest build, shown alongside the earlier information architecture in Figure \ref{fig:retrospective-wireframe}.}
\label{fig:updated-title-screen}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.88\textwidth]{battle-screen-final.png}
\caption{Updated battle overview from the latest build, shown alongside the earlier runtime battle screenshot in Figure \ref{fig:prototype-evidence}.}
\label{fig:updated-battle-screen}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.88\textwidth]{card-interface-final.png}
\caption{Updated card-interface capture from the latest build, shown alongside the earlier hand-and-top-bar view in Figure \ref{fig:prototype-cards}.}
\label{fig:updated-card-interface}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.88\textwidth]{result-victory-final.png}
\caption{Victory result screen from the latest build, documenting the completed positive end-state flow.}
\label{fig:updated-victory-screen}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.88\textwidth]{result-defeat-final.png}
\caption{Defeat result screen from the latest build, documenting the alternate end-state flow.}
\label{fig:updated-defeat-screen}
\end{figure}
